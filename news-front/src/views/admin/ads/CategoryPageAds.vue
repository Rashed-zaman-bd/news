...
import CategoryAdsFormModa from '@/components/Advertis/CategoryAdsFormModal.vue'
import CategoryAdsDeleteModal from '@/components/Advertis/CategoryAdsDeleteModal.vue'
...
const fetchAds = async () => {
    loading.value = true
    try {
        const { data } = await api.get('/admin/category-ads', {
            params: {
