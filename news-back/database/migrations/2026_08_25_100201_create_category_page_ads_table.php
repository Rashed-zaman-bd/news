...
return new class extends Migration
{
    ...
    {
        Schema::create('category_page_ads', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('placement', ['top','middle','middle-two','middle-three','sidebar','sidebar-two',])->default('top');
    ...
    {
        Schema::dropIfExists('category_page_ads');
    }
};
